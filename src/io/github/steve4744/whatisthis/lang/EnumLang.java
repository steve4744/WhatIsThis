...
public enum EnumLang {
	...
	GOT_DE("got_de", new HashMap<String, String>()),
	...
	KAB_KAB("kab_kab", new HashMap<String, String>()),
	...
	MOH_CA("moh_ca", new HashMap<String, String>()),
	...
	NUK("nuk", new HashMap<String, String>()),
	OC_FR("oc_fr", new HashMap<String, String>()),
	OJ_CA("oj_ca", new HashMap<String, String>()),
	...
	SCN("scn", new HashMap<String, String>()),
	...
	SWG("swg", new HashMap<String, String>()),
